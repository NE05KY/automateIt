...
<footer>
И самое крутое во всё этом - все объекты внутри изображения в браузере являются DOM-нодами, 
что позволяет манипулировать с ними с помощью JS & CSS
</footer>
